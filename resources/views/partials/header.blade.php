	...
	<div class=" mx-auto flex justify-around items-center">
		<div class="flex justify-between gap-4 items-center">
			...
			<ul class="flex space-x-4">
				<li>
					<a href="{{  route('home') }}" class="{{ isActiveNavLink('home') }} hover:text-gray-300">{{ __('pages/home.title') }}</a>
				</li>
				<li>
					<a href="{{  route('products:index') }}" class="{{ isActiveNavLink('products:index') }} hover:text-gray-300">{{ __('pages/home.show_all_products') }}</a>
				</li>
			</ul>
		</div>
		<nav>
