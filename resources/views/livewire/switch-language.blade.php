...
<div>
    <nav
        ...
        <button type="button" wire:click="switch('ru')"
            ...
            h-8 md:hover:bg-green-700/70 px-5 font-medium rounded-lg outline-none hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300 dark:focus:text-gray-400">
            Русский
        </button>
    </nav>
</div>
